...
public class PedidoUseCase(IPedidoRepository pedidosRepository,
                    ISacolaProdutoRepository sacolaProdutoRepository,
                    IProdutoHttpService produtoService,
                    ISacolaRepository sacolaRepository) : IPedidoUseCase
{
    private readonly IPedidoRepository _pedidosRepository = pedidosRepository;
    private readonly ISacolaRepository _sacolaRepository = sacolaRepository;
    private readonly ISacolaProdutoRepository _sacolaProdutoRepository = sacolaProdutoRepository;
    private readonly IProdutoHttpService _produtoService = produtoService;
